    ...
    extends AbstractDataValidator
{
     ...
     * {@inheritDoc}
     *
     * For a LOGICAL field a <tt>Boolean</tt>, or a <tt>String</tt> is acceptable.
     * A <tt>String</tt> is acceptable only if it contains one of Y, N, T, F.
     * The String may contain leading and trailing spaces.
     */
